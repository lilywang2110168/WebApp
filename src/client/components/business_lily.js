    ...
    render() {
        ...
        if(this.state.products.length===1){
            ...
            products=<div className="row"> <div className="col-xs-3"/>
                <div className="col-xs-5"><a href={productLink}>
                    <p>{product.title}</p>
          ...
          products = this.state.products.map((product, index)=> {
             ...
             let title=product.title;
               ...
               return <div  key={index}>
                   <div className="col-xs-4"><a href={productLink}>
                   <br/>
                       <p>{title}</p>
                ...
                <form className="form-horizontal">
                    ...
                    <div className="form-group">
                        <div className="col-sm-offset-5 col-sm-10">
                            <button className="btn btn-default searchButton" onClick={this.products}>Search</button>
                            <br/>
                        </div>
